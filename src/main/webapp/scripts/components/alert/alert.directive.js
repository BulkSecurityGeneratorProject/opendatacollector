        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('openDataCollectorApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-openDataCollectorApp-error');
                                var entityKey = httpResponse.headers('X-openDataCollectorApp-params');
                                if (errorHeader) {
